    ...
    <div className="container-xxl">
      <div className="row">
        <div className="col-md-4">
          ...
          <div>
            <address className='text-white fs-6'>Officeno :2789 Near Area Guide,<br />
              G-11, Islamabad<br />
              pincode: 6735412
              Pakistan
            </address>
            <a href="tel: +92 8304802069" className="mt-3 d-block mb-1  text-white">+92 8304802069</a>

            <a href="mailto:outoften98@gmail.com " className="mt-4 d-block mb-0 text-white">outoften98@gmail.com</a>
      ...
      <div className="row">
        <div className="col-12">
          <p className='text-center text-white mb-0'>
            &copy; {new Date().getFullYear()}: Powered by Qurat ul Ain
          </p>
        </div>
      </div>
    </div>
