...
const MaybConcealer = () => {
    const props = { width: 400, height: 500, zoomWidth: 500, img: "/images/maybconc.png" };
    const prop1 = { width: 250, height: 200, zoomWidth: 100, img: "/images/mayb_pc.PNG" };
    const prop2 = { width: 250, height: 200, zoomWidth: 200, img: "/images/tarte_wc.PNG" };
    const prop3 = { width: 250, height: 200, zoomWidth: 300, img: "/images/mayb_1.PNG" };
    const prop4 = { width: 250, height: 200, zoomWidth: 300, img: "/images/mayb_2.PNG" };
    ...
    return (
        <>
            <Meta title="Maybelline Product" />
            <BreadCrumb title="Maybelline Product" />
                        ...
                        <div className="main-product-details">
                            ...
                            <div className=" py-3">
                                ...
                                <div className='d-flex gap-10 align-items-center my-2'>
                                    <h3 className="product-heading">
                                        Brand :
                                    </h3><p className='product-data'>Maybelline</p>
                        ...
                        <div className="reviews mt-4">
                            <div className="review ">
                                <div className='d-flex gap-10 align-items-center'>
                                    <h6 className='mb-0'>Maybelline Concealer</h6>
                                    <ReactStars
                                        edit={false}
                                        count={5}
                                        value={4}
