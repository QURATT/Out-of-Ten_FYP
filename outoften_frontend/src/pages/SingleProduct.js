...
const SingleProduct = () => {
    const props = { width: 400, height: 500, zoomWidth: 500, img: "/images/macbookm1.png" };
    const prop1 = { width: 250, height: 200, zoomWidth: 100, img: "/images/macbook_pc.PNG" };
    const prop2 = { width: 250, height: 200, zoomWidth: 200, img: "/images/macbook_wc.PNG" };
    const prop3 = { width: 250, height: 200, zoomWidth: 300, img: "/images/macbook_1.PNG" };
    const prop4 = { width: 250, height: 200, zoomWidth: 300, img: "/images/macbook_2.PNG" };
    ...
    return (
        <>
            <Meta title="Macbook Product" />
            <BreadCrumb title="Macbook Product" />
                            ...
                            <div className=" py-3">
                                <div className='d-flex gap-10 align-items-center my-2'>
                                    <h3 className="product-heading">
                                        Generation:
                                    </h3><p className='product-data'>12th</p>

                                </div>
                                <div className='d-flex gap-10 align-items-center my-2'>
                                    <h3 className="product-heading">
                                        Brand :
                                    </h3><p className='product-data'>Apple</p>

                                </div>
                                <div className='d-flex gap-10 align-items-center my-2'>
                                    <h3 className="product-heading">
                                        Category :
                                    </h3><p className='product-data'>Macbook</p>
                    ...
                    <div className="col-lg-7 col-md-6 mb-4">
                        ...
                        <div className="main-product-details">
                            ...
                            <div className="img-fluid" style={{
                                ...
                                border: '2px black solid',}}>
                                <div>
                                    <ReactImageZoom {...prop1} width= {370} height= {270}/>
                                </div>
                                {/* <img src="/images/hp_pc.png" className='img-fluid' alt="" /> */}
                            </div> </span>
                        ...
                        <div className="review-form py-4">
                            ...
                            <form action="" className='d-flex flex-column gap-15'>
                                ...
                                <div className='d-flex justify-content-end'>
                                    <button className='button border-0'>Macbook Review</button>
                                </div>
                            </form>
                        </div>
                        <div className="reviews mt-4">
                            <div className="review ">
                                <div className='d-flex gap-10 align-items-center'>
                                    <h6 className='mb-0'>MAcbook M1</h6>
                                    <ReactStars
                                        edit={false}
                                        count={5}
                                        value={4}
