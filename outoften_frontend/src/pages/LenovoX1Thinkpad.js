...
const LenovoX1Thinkpad = () => {
    const props = { width: 400, height: 500, zoomWidth: 500, img: "/images/lenovo_x1.png" };
    const prop1 = { width: 250, height: 200, zoomWidth: 100, img: "/images/lenovox1_pc.PNG" };
    const prop2 = { width: 250, height: 200, zoomWidth: 200, img: "/images/lenovox1_wc.PNG" };
    ...
    return (
        <>
            <Meta title="Lenovo X1 Product" />
            <BreadCrumb title="Lenovo X1 Product" />
                            ...
                            <div className=" py-3">
                                <div className='d-flex gap-10 align-items-center my-2'>
                                    <h3 className="product-heading">
                                        Generation:
                                    </h3><p className='product-data'>7th</p>

                                </div>
                                <div className='d-flex gap-10 align-items-center my-2'>
                                    <h3 className="product-heading">
                                        Brand :
                                    </h3><p className='product-data'>Lenovo X1</p>

                                </div>
                                <div className='d-flex gap-10 align-items-center my-2'>
                                    <h3 className="product-heading">
                                        Category :
                                    </h3><p className='product-data'>Thinkpad</p>
                    ...
                    <div className="col-lg-7 col-md-6 mb-4">
                        <div className="main-product-details">
                            ...
                            <div className="img-fluid" style={{
                                ...
                                border: '2px black solid',}}>
                                <div>
                                    <ReactImageZoom {...prop1} width= {300} height= {250}/>
                                </div>
                            </div> </span>
                        ...
                        <div className="reviews mt-4">
                            <div className="review ">
                                <div className='d-flex gap-10 align-items-center'>
                                    <h6 className='mb-0'>Lenovo X1 Thinkpad</h6>
                                    <ReactStars
                                        edit={false}
                                        count={5}
                                        value={4}
...
export default LenovoX1Thinkpad
