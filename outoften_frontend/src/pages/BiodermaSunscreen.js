...
const BiodermaSunscreen = () => {
    const props = { width: 400, height: 500, zoomWidth: 500, img: "/images/biodermasunsc.jpg" };
    const prop1 = { width: 250, height: 200, zoomWidth: 100, img: "/images/bioderma_pc.PNG" };
    const prop2 = { width: 250, height: 200, zoomWidth: 200, img: "/images/bioderma_wc.PNG" };
    const prop3 = { width: 250, height: 200, zoomWidth: 300, img: "/images/bioderma_1.PNG" };
    const prop4 = { width: 250, height: 200, zoomWidth: 300, img: "/images/bioderma_2.PNG" };
    ...
    return (
        <>
            <Meta title="Bioderma Product" />
            <BreadCrumb title="Bioderma Product" />
                            ...
                            {/* <div className="border-bottom py-3">
                                ...
                                <div className='d-flex align-items-center gap-10'>
                                    ...
                                    <ReactStars
                                        ...
                                        activeColor="#ffd700"
                                    />
                                    <p className='mb-0 t-review'>(120 Reviews)</p>
                                </div>
                            ...
                            <div className=" py-3">
                                <div className='d-flex gap-10 align-items-center my-2'>
                                    <h3 className="product-heading">
                                        Skin:
                                    </h3><p className='product-data'>Dry & Oily</p>

                                </div>
                                <div className='d-flex gap-10 align-items-center my-2'>
                                    <h3 className="product-heading">
                                        Brand :
                                    </h3><p className='product-data'>Bioderma</p>

                                </div>
                                <div className='d-flex gap-10 align-items-center my-2'>
                                    <h3 className="product-heading">
                                        Category :
                                    </h3><p className='product-data'>Sunscreen</p>
                    ...
                    <div className="col-lg-7 col-md-6 mb-4">
                        ...
                        <div className="main-product-details">
                            ...
                            <div className="img-fluid" style={{
                                ...
                                border: '2px black solid',}}>
                                <div>
                                    <ReactImageZoom {...prop1} width= {330} height= {250}/>
                                </div>
                                {/* <img src="/images/hp_pc.png" className='img-fluid' alt="" /> */}
                            </div> </span>
                        ...
                        <div className="reviews mt-4">
                            <div className="review ">
                                <div className='d-flex gap-10 align-items-center'>
                                    <h6 className='mb-0'>Bioderma Sunscreen</h6>
                                    <ReactStars
                                        edit={false}
                                        count={5}
                                        value={4}
...
export default BiodermaSunscreen
