...
const TarteConcealer = () => {
    const props = { width: 400, height: 500, zoomWidth: 500, img: "/images/tarteconc.png" };
    const prop1 = { width: 250, height: 200, zoomWidth: 100, img: "/images/tarte_pc.PNG" };
    const prop2 = { width: 250, height: 200, zoomWidth: 200, img: "/images/tarte_wc.PNG" };
    const prop3 = { width: 250, height: 200, zoomWidth: 300, img: "/images/tarte_1.PNG" };
    const prop4 = { width: 250, height: 200, zoomWidth: 300, img: "/images/tarte_2.PNG" };
    ...
    return (
        <>
            <Meta title="Tarte Product" />
            <BreadCrumb title="Tarte Product" />
                            ...
                            <div className=" py-3">
                                <div className='d-flex gap-10 align-items-center my-2'>
                                    <h3 className="product-heading">
                                        Skin:
                                    </h3><p className='product-data'>For All Complexions</p>

                                </div>
                                <div className='d-flex gap-10 align-items-center my-2'>
                                    <h3 className="product-heading">
                                        Brand :
                                    </h3><p className='product-data'>Tarte</p>

                                </div>
                                <div className='d-flex gap-10 align-items-center my-2'>
                                    <h3 className="product-heading">
                                        Category :
                                    </h3><p className='product-data'>Concealer</p>
                        ...
                        <div className="reviews mt-4">
                            <div className="review ">
                                <div className='d-flex gap-10 align-items-center'>
                                    <h6 className='mb-0'>Tarte Concealer</h6>
                                    <ReactStars
                                        edit={false}
                                        count={5}
                                        value={4}
